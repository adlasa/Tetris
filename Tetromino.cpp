...
{
  cout << "<rect fill=\"" << color() << "\" stroke=\"black\" x=\"" << getX(0)*50 << "\" y=\"" << getY(0)*50 << "\" width=\"50\" height=\"50\"/>" << endl;
  cout << "<rect fill=\"" << color() << "\" stroke=\"black\" x=\"" << getX(1)*50 << "\" y=\"" << getY(1)*50 << "\" width=\"50\" height=\"50\"/>" << endl;
  cout << "<rect fill=\"" << color() << "\" stroke=\"black\" x=\"" << getX(2)*50 << "\" y=\"" << getY(2)*50 << "\" width=\"50\" height=\"50\"/>" << endl;
  cout << "<rect fill=\"" << color() << "\" stroke=\"black\" x=\"" << getX(3)*50 << "\" y=\"" << getY(3)*50 << "\" width=\"50\" height=\"50\"/>" << endl;
}
